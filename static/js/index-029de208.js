import{aA as q,a6 as f,Z as o,ai as J,$ as k,a5 as M,bu as Q,bv as U,d as O,a1 as H,O as j,cP as X,G as w,ap as B,a4 as K,bO as Y,H as c,W as ee,an as I,a9 as te,o as oe,c as re,e as p,h as y,T as u,f as V}from"./main-6cdda1e7.js";import{u as ne}from"./use-compitable-09e23fb4.js";import{g as se}from"./get-slot-811d317b.js";import{b as W}from"./route-block-7ae06361.js";function G(t,s="default",i=[]){const{children:n}=t;if(n!==null&&typeof n=="object"&&!Array.isArray(n)){const l=n[s];if(typeof l=="function")return l()}return i}let N=!1;function ie(){if(!!q&&!!window.CSS&&!N&&(N=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}const Z=Symbol("DESCRIPTION_ITEM_FLAG");function le(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[Z]:!1}const ae=f([o("descriptions",{fontSize:"var(--n-font-size)"},[o("descriptions-separator",`
 display: inline-block;
 margin: 0 8px 0 2px;
 `),o("descriptions-table-wrapper",[o("descriptions-table",[o("descriptions-table-row",[o("descriptions-table-header",{padding:"var(--n-th-padding)"}),o("descriptions-table-content",{padding:"var(--n-td-padding)"})])])]),J("bordered",[o("descriptions-table-wrapper",[o("descriptions-table",[o("descriptions-table-row",[f("&:last-child",[o("descriptions-table-content",{paddingBottom:0})])])])])]),k("left-label-placement",[o("descriptions-table-content",[f("> *",{verticalAlign:"top"})])]),k("left-label-align",[f("th",{textAlign:"left"})]),k("center-label-align",[f("th",{textAlign:"center"})]),k("right-label-align",[f("th",{textAlign:"right"})]),k("bordered",[o("descriptions-table-wrapper",`
...
`),fe=Object.assign(Object.assign({},j.props),{size:[String,Number],fontSize:[String,Number],type:{type:String,default:"primary"},color:[Object,String],gradient:[Object,String]}),ve=O({name:"GradientText",props:fe,setup(t){ie();const{mergedClsPrefixRef:s,inlineThemeDisabled:i}=H(t),n=w(()=>{const{type:e}=t;return e==="danger"?"error":e}),l=w(()=>{let e=t.size||t.fontSize;return e&&(e=te(e)),e||void 0}),a=w(()=>{const e=t.color||t.gradient;if(typeof e=="string")return e;if(e){const v=e.deg||0,h=e.from,_=e.to;return`linear-gradient(${v}deg, ${h} 0%, ${_} 100%)`}}),d=j("GradientText","-gradient-text",me,he,t,s),g=w(()=>{const{value:e}=n,{common:{cubicBezierEaseInOut:v},self:{rotate:h,[B("colorStart",e)]:_,[B("colorEnd",e)]:C,fontWeight:A}}=d.value;return{"--n-bezier":v,"--n-rotate":h,"--n-color-start":_,"--n-color-end":C,"--n-font-weight":A}}),b=i?K("gradient-text",w(()=>n.value[0]),g,t):void 0;return{mergedClsPrefix:s,compatibleType:n,styleFontSize:l,styleBgImage:a,cssVars:i?void 0:g,themeClass:b==null?void 0:b.themeClass,onRender:b==null?void 0:b.onRender}},render(){const{mergedClsPrefix:t,onRender:s}=this;return s==null||s(),c("span",{class:[`${t}-gradient-text`,`${t}-gradient-text--${this.compatibleType}-type`,this.themeClass],style:[{fontSize:this.styleFontSize,backgroundImage:this.styleBgImage},this.cssVars]},this.$slots)}}),_e=u(" xicons from '@vicons/ionicons5'"),ye=V("br",null,null,-1),we=u("naiveui\u63A8\u8350\u56FE\u6807\u5730\u5740 "),Se=u(" https://www.xicons.org/#/ "),xe=u(" unocss from 'unocss' "),Ce=V("br",null,null,-1),ze=u("\u539F\u5B50css\u641C\u7D22\u8783\u87F9 "),$e=u("https://uno.antfu.me/"),Pe=u(" naiveui from 'naive-ui' "),Re=V("br",null,null,-1),Te=u("naiveui\u8783\u87F9"),Ee=u("https://www.naiveui.com/"),ke=u(" vueuse from '@vueuse/core' "),Ie=V("br",null,null,-1),Be=u("vueuse\u5DE5\u5177\u5E93\u8783\u87F9"),Oe=u("https://vueuse.org/guide/"),Ae=O({name:"tool"}),je=O({...Ae,setup(t){return(s,i)=>{const n=ve,l=be,a=de;return oe(),re(a,{"label-placement":"left",bordered:""},{default:p(()=>[y(l,null,{label:p(()=>[_e,ye,we]),default:p(()=>[y(n,{type:"success"},{default:p(()=>[Se]),_:1})]),_:1}),y(l,null,{label:p(()=>[xe,Ce,ze]),default:p(()=>[y(n,{type:"success"},{default:p(()=>[$e]),_:1})]),_:1}),y(l,null,{label:p(()=>[Pe,Re,Te]),default:p(()=>[y(n,{type:"success"},{default:p(()=>[Ee]),_:1})]),_:1}),y(l,null,{label:p(()=>[ke,Ie,Be]),default:p(()=>[y(n,{type:"success"},{default:p(()=>[Oe]),_:1})]),_:1})]),_:1})}}});typeof W=="function"&&W(je);export{je as default};
