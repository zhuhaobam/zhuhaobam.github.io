import{S as z,a1 as f,T as d,d as T,W as w,V as g,bJ as B,H as u,aJ as a,Z as R,I as c}from"./main-b7c9a53e.js";import{u as P}from"./use-compitable-f559da67.js";const V=z("h",`
...
`,[f("&:first-child",{marginTop:0}),d("prefix-bar",{position:"relative",paddingLeft:"var(--n-prefix-width)"},[d("align-text",{paddingLeft:0},[f("&::before",{left:"calc(-1 * var(--n-prefix-width))"})]),f("&::before",`
 ...
 bottom: 0;
 position: absolute;
 `),f("&::before",{backgroundColor:"var(--n-bar-color)"})])]),_=Object.assign(Object.assign({},g.props),{type:{type:String,default:"default"},prefix:String,alignText:Boolean}),l=e=>T({name:`H${e}`,props:_,setup(o){const{mergedClsPrefixRef:i,inlineThemeDisabled:n}=w(o),r=g("Typography","-h",V,B,o,i),t=u(()=>{const{type:h}=o,{common:{cubicBezierEaseInOut:m},self:{headerFontWeight:b,headerTextColor:x,[a("headerPrefixWidth",e)]:p,[a("headerFontSize",e)]:v,[a("headerMargin",e)]:C,[a("headerBarWidth",e)]:y,[a("headerBarColor",h)]:$}}=r.value;return{"--n-bezier":m,"--n-font-size":v,"--n-margin":C,"--n-bar-color":$,"--n-bar-width":y,"--n-font-weight":b,"--n-text-color":x,"--n-prefix-width":p}}),s=n?R(`h${e}`,u(()=>o.type[0]),t,o):void 0;return{mergedClsPrefix:i,cssVars:n?void 0:t,themeClass:s==null?void 0:s.themeClass,onRender:s==null?void 0:s.onRender}},render(){var o;const{prefix:i,alignText:n,mergedClsPrefix:r,cssVars:t,$slots:s}=this;return(o=this.onRender)===null||o===void 0||o.call(this),c(`h${e}`,{class:[`${r}-h`,`${r}-h${e}`,this.themeClass,{[`${r}-h--prefix-bar`]:i,[`${r}-h--align-text`]:n}],style:t},s)}}),j=l("1");l("2");l("3");l("4");l("5");l("6");const W=z("text",`
 transition: color .3s var(--n-bezier);
 color: var(--n-text-color);
`,[d("strong",`
