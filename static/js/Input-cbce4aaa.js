...
`,[s("input, textarea",`
 ...
 height: 0;
 display: none;
 `),y("&::placeholder","color: #0000;"),y("&:-webkit-autofill ~",[s("placeholder","display: none;")])]),R("round",[N("textarea","border-radius: calc(var(--n-height) / 2);")]),s("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),R("textarea",[s("placeholder","overflow: visible;")]),N("autosize","width: 100%;"),R("autosize",[s("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `),["warning","error"].map(r=>R(`${r}-status`,[N("disabled",[b("base-loading",`
