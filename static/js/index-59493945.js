import{O as b,m as e,Q as H,n as P,P as j,bE as q,bF as K,d as k,q as Q,p as N,cD as W,c as M,aw as I,s as J,bP as U,t as i,e as X,f as Y,g as s,h as u,ae as t,x as A}from"./main-291f3adb.js";import{u as Z}from"./use-compitable-feaa162f.js";import{g as ee}from"./get-slot-6dd27322.js";import{b as V}from"./route-block-7ae06361.js";function L(l,h="default",a=[]){const{children:r}=l;if(r!==null&&typeof r=="object"&&!Array.isArray(r)){const d=r[h];if(typeof d=="function")return d()}return a}const G=Symbol("DESCRIPTION_ITEM_FLAG");function oe(l){return typeof l=="object"&&l&&!Array.isArray(l)?l.type&&l.type[G]:!1}const te=b([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),re=Object.assign(Object.assign({},N.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:{type:String,default:"medium"},bordered:Boolean,labelStyle:[Object,String],contentStyle:[Object,String]}),ne=k({name:"Descriptions",props:re,setup(l){const{mergedClsPrefixRef:h,inlineThemeDisabled:a}=Q(l),r=N("Descriptions","-descriptions",te,W,l,h),d=M(()=>{const{size:c,bordered:m}=l,{common:{cubicBezierEaseInOut:v},self:{titleTextColor:n,thColor:E,thColorModal:w,thColorPopover:R,thTextColor:B,thFontWeight:T,tdTextColor:D,tdColor:o,tdColorModal:y,tdColorPopover:F,borderColor:p,borderColorModal:_,borderColorPopover:x,borderRadius:C,lineHeight:f,[I("fontSize",c)]:S,[I(m?"thPaddingBordered":"thPadding",c)]:z,[I(m?"tdPaddingBordered":"tdPadding",c)]:$}}=r.value;return{"--n-title-text-color":n,"--n-th-padding":z,"--n-td-padding":$,"--n-font-size":S,"--n-bezier":v,"--n-th-font-weight":T,"--n-line-height":f,"--n-th-text-color":B,"--n-td-text-color":D,"--n-th-color":E,"--n-th-color-modal":w,"--n-th-color-popover":R,"--n-td-color":o,"--n-td-color-modal":y,"--n-td-color-popover":F,"--n-border-radius":C,"--n-border-color":p,"--n-border-color-modal":_,"--n-border-color-popover":x}}),g=a?J("descriptions",M(()=>{let c="";const{size:m,bordered:v}=l;return v&&(c+="a"),c+=m[0],c}),d,l):void 0;return{mergedClsPrefix:h,cssVars:a?void 0:d,themeClass:g==null?void 0:g.themeClass,onRender:g==null?void 0:g.onRender,compitableColumn:Z(l,["columns","column"]),inlineThemeDisabled:a}},render(){const l=this.$slots.default,h=l?U(l()):[];h.length;const{compitableColumn:a,labelPlacement:r,labelAlign:d,size:g,bordered:c,title:m,cssVars:v,mergedClsPrefix:n,separator:E,onRender:w}=this;w==null||w();const R=h.filter(o=>oe(o)),B={span:0,row:[],secondRow:[],rows:[]},D=R.reduce((o,y,F)=>{const p=y.props||{},_=R.length-1===F,x=["label"in p?p.label:L(y,"label")],C=[L(y)],f=p.span||1,S=o.span;o.span+=f;const z=p.labelStyle||p["label-style"]||this.labelStyle,$=p.contentStyle||p["content-style"]||this.contentStyle;if(r==="left")c?o.row.push(i("th",{class:`${n}-descriptions-table-header`,colspan:1,style:z},x),i("td",{class:`${n}-descriptions-table-content`,colspan:_?(a-S)*2+1:f*2-1,style:$},C)):o.row.push(i("td",{class:`${n}-descriptions-table-content`,colspan:_?(a-S)*2:f*2},i("span",{class:`${n}-descriptions-table-content__label`,style:z},[...x,E&&i("span",{class:`${n}-descriptions-separator`},E)]),i("span",{class:`${n}-descriptions-table-content__content`,style:$},C)));else{const O=_?(a-S)*2:f*2;o.row.push(i("th",{class:`${n}-descriptions-table-header`,colspan:O,style:z},x)),o.secondRow.push(i("td",{class:`${n}-descriptions-table-content`,colspan:O,style:$},C))}return(o.span>=a||_)&&(o.span=0,o.row.length&&(o.rows.push(o.row),o.row=[]),r!=="left"&&o.secondRow.length&&(o.rows.push(o.secondRow),o.secondRow=[])),o},B).rows.map(o=>i("tr",{class:`${n}-descriptions-table-row`},o));return i("div",{style:v,class:[`${n}-descriptions`,this.themeClass,`${n}-descriptions--${r}-label-placement`,`${n}-descriptions--${d}-label-align`,`${n}-descriptions--${g}-size`,c&&`${n}-descriptions--bordered`]},m||this.$slots.header?i("div",{class:`${n}-descriptions-header`},m||ee(this,"header")):null,i("div",{class:`${n}-descriptions-table-wrapper`},i("table",{class:`${n}-descriptions-table`},i("tbody",null,D))))}}),se={label:String,span:{type:Number,default:1},labelStyle:[Object,String],contentStyle:[Object,String]},le=k({name:"DescriptionsItem",[G]:!0,props:se,render(){return null}}),ie=t(" xicons from '@vicons/ionicons5'"),ae=A("br",null,null,-1),ce=t("naiveui\u63A8\u8350\u56FE\u6807\u5730\u5740 "),de=t(" https://www.xicons.org/#/ "),pe=t(" unocss from 'unocss' "),be=A("br",null,null,-1),ue=t("\u539F\u5B50css\u641C\u7D22\u8783\u87F9 "),he=t(" https://uno.antfu.me/ "),ge=t(" naiveui from 'naive-ui' "),me=A("br",null,null,-1),_e=t("naiveui\u8783\u87F9"),fe=t(" https://www.naiveui.com/ "),ve=t(" vueuse from '@vueuse/core' "),we=A("br",null,null,-1),ye=t("vueuse\u5DE5\u5177\u5E93\u8783\u87F9"),xe=t(" https://vueuse.org/guide/ "),Ce=t(" iconify\u56FE\u6807"),Se=t(" http://icon-sets.iconify.design/ant-design/ "),ze=t(" naive-ui\u63A8\u8350vicons\u56FE\u6807"),$e=t(" https://www.xicons.org/#/zh-CN "),Pe=t(" google-closure-library "),Ae=A("br",null,null,-1),Ee=t("closure-library\u5DE5\u5177\u5E93"),Re=t(" https://github.com/google/closure-library "),ke=t(" vue3\u793E\u533A\u6587\u6863"),Be=t(" https://vue3js.cn/ "),De=t(" vue3\u793E\u533A\u6587\u6863"),Fe=t(" http://www.liulongbin.top:8085/ "),Ie=k({name:"tool"}),Te=k({...Ie,setup(l){return(h,a)=>{const r=le,d=ne;return X(),Y(d,{"label-placement":"left",bordered:""},{default:s(()=>[u(r,null,{label:s(()=>[ie,ae,ce]),default:s(()=>[de]),_:1}),u(r,null,{label:s(()=>[pe,be,ue]),default:s(()=>[he]),_:1}),u(r,null,{label:s(()=>[ge,me,_e]),default:s(()=>[fe]),_:1}),u(r,null,{label:s(()=>[ve,we,ye]),default:s(()=>[xe]),_:1}),u(r,null,{label:s(()=>[Ce]),default:s(()=>[Se]),_:1}),u(r,null,{label:s(()=>[ze]),default:s(()=>[$e]),_:1}),u(r,null,{label:s(()=>[Pe,Ae,Ee]),default:s(()=>[Re]),_:1}),u(r,null,{label:s(()=>[ke]),default:s(()=>[Be]),_:1}),u(r,null,{label:s(()=>[De]),default:s(()=>[Fe]),_:1})]),_:1})}}});typeof V=="function"&&V(Te);export{Te as default};
