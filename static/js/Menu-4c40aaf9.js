import{d as E,I as p,a4 as V,ac as M,H as b,a6 as L,ah as F,R as he,ab as pe,r as q,ai as ie,aj as fe,ak as G,al as U,aa as f,a2 as h,a3 as C,a9 as d,am as j,an as xe,a5 as ge,O as le,ao as be,ap as ee,ae as oe,af as N,a8 as Ce}from"./main-25752506.js";import{_ as ze,c as ye}from"./Dropdown-7654924f.js";import{_ as Ie}from"./Tooltip-537c243c.js";import{u as te}from"./use-merged-state-888797cf.js";import{u as we}from"./use-compitable-c343a5c6.js";const Se=E({name:"ChevronDownFilled",render(){return p("svg",{viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},p("path",{d:"M3.20041 5.73966C3.48226 5.43613 3.95681 5.41856 4.26034 5.70041L8 9.22652L11.7397 5.70041C12.0432 5.41856 12.5177 5.43613 12.7996 5.73966C13.0815 6.0432 13.0639 6.51775 12.7603 6.7996L8.51034 10.7996C8.22258 11.0668 7.77743 11.0668 7.48967 10.7996L3.23966 6.7996C2.93613 6.51775 2.91856 6.0432 3.20041 5.73966Z",fill:"currentColor"}))}}),Ae=V("n-layout-sider"),Ve={type:String,default:"static"},_=V("n-menu"),W=V("n-submenu"),Z=V("n-menu-item-group"),B=8;function J(e){const r=M(_),{props:n,mergedCollapsedRef:i}=r,l=M(W,null),a=M(Z,null),s=b(()=>n.mode==="horizontal"),v=b(()=>s.value?n.dropdownPlacement:"tmNodes"in e?"right-start":"right"),c=b(()=>{var u;return Math.max((u=n.collapsedIconSize)!==null&&u!==void 0?u:n.iconSize,n.iconSize)}),y=b(()=>{var u;return!s.value&&e.root&&i.value&&(u=n.collapsedIconSize)!==null&&u!==void 0?u:n.iconSize}),R=b(()=>{if(s.value)return;const{collapsedWidth:u,indent:w,rootIndent:A}=n,{root:S,isGroup:H}=e,P=A===void 0?w:A;if(S)return i.value?u/2-c.value/2:P;if(a)return w/2+a.paddingLeftRef.value;if(l)return(H?w/2:w)+l.paddingLeftRef.value}),z=b(()=>{const{collapsedWidth:u,indent:w,rootIndent:A}=n,{value:S}=c,{root:H}=e;return s.value||!H||!i.value?B:(A===void 0?w:A)+S+B-(u+S)/2});return{dropdownPlacement:v,activeIconSize:y,maxIconSize:c,paddingLeft:R,iconMarginRight:z,NMenu:r,NSubmenu:l}}const Q={internalKey:{type:[String,Number],required:!0},root:Boolean,isGroup:Boolean,level:{type:Number,required:!0},title:[String,Function],extra:[String,Function]},ae=Object.assign(Object.assign({},Q),{tmNode:{type:Object,required:!0},tmNodes:{type:Array,required:!0}}),Re=E({name:"MenuOptionGroup",props:ae,setup(e){L(W,null);const r=J(e);L(Z,{paddingLeftRef:r.paddingLeft});const{mergedClsPrefixRef:n,props:i}=M(_);return function(){const{value:l}=n,a=r.paddingLeft.value,{nodeProps:s}=i,v=s==null?void 0:s(e.tmNode.rawNode);return p("div",{class:`${l}-menu-item-group`,role:"group"},p("div",Object.assign({},v,{class:[`${l}-menu-item-group-title`,v==null?void 0:v.class],style:[(v==null?void 0:v.style)||"",a!==void 0?`padding-left: ${a}px;`:""]}),F(e.title),e.extra?p(he,null," ",F(e.extra)):null),p("div",null,e.tmNodes.map(c=>X(c,i))))}}}),ce=E({name:"MenuOptionContent",props:{collapsed:Boolean,disabled:Boolean,title:[String,Function],icon:Function,extra:[String,Function],showArrow:Boolean,childActive:Boolean,hover:Boolean,paddingLeft:Number,selected:Boolean,maxIconSize:{type:Number,required:!0},activeIconSize:{type:Number,required:!0},iconMarginRight:{type:Number,required:!0},clsPrefix:{type:String,required:!0},onClick:Function,tmNode:{type:Object,required:!0}},setup(e){const{props:r}=M(_);return{menuProps:r,style:b(()=>{const{paddingLeft:n}=e;return{paddingLeft:n&&`${n}px`}}),iconStyle:b(()=>{const{maxIconSize:n,activeIconSize:i,iconMarginRight:l}=e;return{width:`${n}px`,height:`${n}px`,fontSize:`${i}px`,marginRight:`${l}px`}})}},render(){const{clsPrefix:e,tmNode:r,menuProps:{renderIcon:n,renderLabel:i,renderExtra:l,expandIcon:a}}=this,s=n?n(r.rawNode):F(this.icon);return p("div",{onClick:v=>{var c;(c=this.onClick)===null||c===void 0||c.call(this,v)},role:"none",class:[`${e}-menu-item-content`,{[`${e}-menu-item-content--selected`]:this.selected,[`${e}-menu-item-content--collapsed`]:this.collapsed,[`${e}-menu-item-content--child-active`]:this.childActive,[`${e}-menu-item-content--disabled`]:this.disabled,[`${e}-menu-item-content--hover`]:this.hover}],style:this.style},s&&p("div",{class:`${e}-menu-item-content__icon`,style:this.iconStyle,role:"none"},[s]),p("div",{class:`${e}-menu-item-content-header`,role:"none"},i?i(r.rawNode):F(this.title),this.extra||l?p("span",{class:`${e}-menu-item-content-header__extra`}," ",l?l(r.rawNode):F(this.extra)):null),this.showArrow?p(pe,{ariaHidden:!0,class:`${e}-menu-item-content__arrow`,clsPrefix:e},{default:()=>a?a(r.rawNode):p(Se,null)}):null)}}),de=Object.assign(Object.assign({},Q),{rawNodes:{type:Array,default:()=>[]},tmNodes:{type:Array,default:()=>[]},tmNode:{type:Object,required:!0},disabled:{type:Boolean,default:!1},icon:Function,onClick:Function}),He=E({name:"Submenu",props:de,setup(e){const r=J(e),{NMenu:n,NSubmenu:i}=r,{props:l,mergedCollapsedRef:a,mergedThemeRef:s}=n,v=b(()=>{const{disabled:u}=e;return i!=null&&i.mergedDisabledRef.value||l.disabled?!0:u}),c=q(!1);L(W,{paddingLeftRef:r.paddingLeft,mergedDisabledRef:v}),L(Z,null);function y(){const{onClick:u}=e;u&&u()}function R(){v.value||(a.value||n.toggleExpand(e.internalKey),y())}function z(u){c.value=u}return{menuProps:l,mergedTheme:s,doSelect:n.doSelect,inverted:n.invertedRef,isHorizontal:n.isHorizontalRef,mergedClsPrefix:n.mergedClsPrefixRef,maxIconSize:r.maxIconSize,activeIconSize:r.activeIconSize,iconMarginRight:r.iconMarginRight,dropdownPlacement:r.dropdownPlacement,dropdownShow:c,paddingLeft:r.paddingLeft,mergedDisabled:v,mergedValue:n.mergedValueRef,childActive:ie(()=>n.activePathRef.value.includes(e.internalKey)),collapsed:b(()=>l.mode==="horizontal"?!1:a.value?!0:!n.mergedExpandedKeysRef.value.includes(e.internalKey)),dropdownEnabled:b(()=>!v.value&&(l.mode==="horizontal"||a.value)),handlePopoverShowChange:z,handleClick:R}},render(){var e;const{mergedClsPrefix:r,menuProps:{renderIcon:n,renderLabel:i}}=this,l=()=>{const{isHorizontal:s,paddingLeft:v,collapsed:c,mergedDisabled:y,maxIconSize:R,activeIconSize:z,title:u,childActive:w,icon:A,handleClick:S,menuProps:{nodeProps:H},dropdownShow:P,iconMarginRight:D,tmNode:k,mergedClsPrefix:$}=this,K=H==null?void 0:H(k.rawNode);return p("div",Object.assign({},K,{class:[`${$}-menu-item`,K==null?void 0:K.class],role:"menuitem"}),p(ce,{tmNode:k,paddingLeft:v,collapsed:c,disabled:y,iconMarginRight:D,maxIconSize:R,activeIconSize:z,title:u,extra:this.extra,showArrow:!s,childActive:w,clsPrefix:$,icon:A,hover:P,onClick:S}))},a=()=>p(fe,null,{default:()=>{const{tmNodes:s,collapsed:v}=this;return v?null:p("div",{class:`${r}-submenu-children`,role:"menu"},s.map(c=>X(c,this.menuProps)))}});return this.root?p(ze,Object.assign({size:"large"},(e=this.menuProps)===null||e===void 0?void 0:e.dropdownProps,{themeOverrides:this.mergedTheme.peerOverrides.Dropdown,theme:this.mergedTheme.peers.Dropdown,builtinThemeOverrides:{fontSizeLarge:"14px",optionIconSizeLarge:"18px"},value:this.mergedValue,trigger:"hover",disabled:!this.dropdownEnabled,placement:this.dropdownPlacement,keyField:this.menuProps.keyField,labelField:this.menuProps.labelField,childrenField:this.menuProps.childrenField,onUpdateShow:this.handlePopoverShowChange,options:this.rawNodes,onSelect:this.doSelect,inverted:this.inverted,renderIcon:n,renderLabel:i}),{default:()=>p("div",{class:`${r}-submenu`,role:"menuitem","aria-expanded":!this.collapsed},l(),this.isHorizontal?null:a())}):p("div",{class:`${r}-submenu`,role:"menuitem","aria-expanded":!this.collapsed},l(),a())}}),se=Object.assign(Object.assign({},Q),{tmNode:{type:Object,required:!0},disabled:Boolean,icon:Function,onClick:Function}),Pe=E({name:"MenuOption",props:se,setup(e){const r=J(e),{NSubmenu:n,NMenu:i}=r,{props:l,mergedClsPrefixRef:a,mergedCollapsedRef:s}=i,v=n?n.mergedDisabledRef:{value:!1},c=b(()=>v.value||e.disabled);function y(z){const{onClick:u}=e;u&&u(z)}function R(z){c.value||(i.doSelect(e.internalKey,e.tmNode.rawNode),y(z))}return{mergedClsPrefix:a,dropdownPlacement:r.dropdownPlacement,paddingLeft:r.paddingLeft,iconMarginRight:r.iconMarginRight,maxIconSize:r.maxIconSize,activeIconSize:r.activeIconSize,mergedTheme:i.mergedThemeRef,menuProps:l,dropdownEnabled:ie(()=>e.root&&s.value&&l.mode!=="horizontal"&&!c.value),selected:b(()=>i.mergedValueRef.value===e.internalKey),mergedDisabled:c,handleClick:R}},render(){const{mergedClsPrefix:e,mergedTheme:r,tmNode:n,menuProps:{renderLabel:i,nodeProps:l}}=this,a=l==null?void 0:l(n.rawNode);return p("div",Object.assign({},a,{role:"menuitem",class:[`${e}-menu-item`,a==null?void 0:a.class]}),p(Ie,{theme:r.peers.Tooltip,themeOverrides:r.peerOverrides.Tooltip,trigger:"hover",placement:this.dropdownPlacement,disabled:!this.dropdownEnabled||this.title===void 0,internalExtraClass:["menu-tooltip"]},{default:()=>i?i(n.rawNode):F(this.title),trigger:()=>p(ce,{tmNode:n,clsPrefix:e,paddingLeft:this.paddingLeft,iconMarginRight:this.iconMarginRight,maxIconSize:this.maxIconSize,activeIconSize:this.activeIconSize,selected:this.selected,title:this.title,extra:this.extra,disabled:this.mergedDisabled,icon:this.icon,onClick:this.handleClick})}))}}),Ne=E({name:"MenuDivider",setup(){const e=M(_),{mergedClsPrefixRef:r,isHorizontalRef:n}=e;return()=>n.value?null:p("div",{class:`${r.value}-menu-divider`})}}),Te=G(ae),Me=G(se),Ee=G(de);function Ke(e){return e.type==="divider"||e.type==="render"}function Oe(e){return e.type==="divider"}function X(e,r){const{rawNode:n}=e,{show:i}=n;if(typeof i=="boolean"&&!i)return null;if(Ke(n))return Oe(n)?p(Ne,Object.assign({key:e.key},n.props)):null;const{labelField:l}=r,{key:a,level:s,isGroup:v}=e,c=Object.assign(Object.assign({},n),{title:n.title||n[l],extra:n.titleExtra||n.extra,key:a,internalKey:a,level:s,root:s===0,isGroup:v});return e.children?e.isGroup?p(Re,U(c,Te,{tmNode:e,tmNodes:e.children,key:a})):p(He,U(c,Ee,{key:a,rawNodes:n[r.childrenField],tmNodes:e.children,tmNode:e})):p(Pe,U(c,Me,{key:a,tmNode:e}))}const ne=[f("&::before","background-color: var(--n-item-color-hover);"),d("arrow",`
