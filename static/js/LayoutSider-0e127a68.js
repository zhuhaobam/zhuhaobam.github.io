import{ak as q,al as G,am as J,an as F,c as a,a as y,G as Q,d as j,u as $,r as R,b as M,I as N,ao as A,e as x,f as W,h as c,ac as H,S as s,R as z,L as Z,H as ee,ap as L,X as Y,Y as P}from"./main-9ba4ca0c.js";import{C as oe}from"./ChevronRight-eeaae470.js";import{p as V,l as te}from"./interface-c8b806fa.js";import{u as re}from"./use-merged-state-2db9ff78.js";const le=e=>{const{baseColor:o,textColor2:r,bodyColor:d,cardColor:f,dividerColor:b,actionColor:C,scrollbarColor:S,scrollbarColorHover:v,invertedColor:g}=e;return{textColor:r,textColorInverted:"#FFF",color:d,colorEmbedded:C,headerColor:f,headerColorInverted:g,footerColor:C,footerColorInverted:g,headerBorderColor:b,headerBorderColorInverted:g,footerBorderColor:b,footerBorderColorInverted:g,siderBorderColor:b,siderBorderColorInverted:g,siderColor:f,siderColorInverted:g,siderToggleButtonBorder:`1px solid ${b}`,siderToggleButtonColor:o,siderToggleButtonIconColor:r,siderToggleButtonIconColorInverted:r,siderToggleBarColor:F(d,S),siderToggleBarColorHover:F(d,v),__invertScrollbar:"true"}},ne=q({name:"Layout",common:G,peers:{Scrollbar:J},self:le}),U=ne,se=a("layout",`
